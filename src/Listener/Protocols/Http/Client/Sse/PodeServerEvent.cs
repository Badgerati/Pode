...
namespace Pode.Protocols.Http.Client.Sse
{
    public class PodeServerEvent : PodeClientConnection
    {
        ...
        public PodeServerEvent(PodeHttpContext context, string name, string group, string clientId, PodeClientConnectionScope scope, bool trackEvents, int retry, bool allowAllOrigins)
        ...
        public override void Dispose()
        {
            ...
            lock (Lockable)
            {
                ...
                HttpListener.RemoveSseConnection(this);
                base.Dispose();
