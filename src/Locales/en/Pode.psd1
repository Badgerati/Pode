@{
    ...
    pemCertificateNotSupportedOnPowerShell5ExceptionMessage           = 'PEM certificate format is not supported in PowerShell 5.1. Please use a different certificate format or upgrade to PowerShell 7.0 or later.'
