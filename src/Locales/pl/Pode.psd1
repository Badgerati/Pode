@{
    ...
    pemCertificateNotSupportedOnPowerShell5ExceptionMessage           = 'Format certyfikatu PEM nie jest obsługiwany w PowerShell 5.1. Użyj innego formatu certyfikatu lub zaktualizuj do PowerShell 7.0 lub nowszego.'
}