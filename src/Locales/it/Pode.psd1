@{
    ...
    eolPowerShellWarningMessage                                       = '[AVVERTENZA] Pode {0} non è stato testato su PowerShell {1}, poiché è EOL.'
    ...
    invalidWebExceptionTypeExceptionMessage                           = "L'eccezione è di un tipo non valido, dovrebbe essere WebException o HttpRequestException, ma è stato ottenuto: {0}"
    ...
    scheduleStartTimeAfterEndTimeExceptionMessage                     = "[Schedulatore] {0}: Non può avere un 'StartTime' dopo 'EndTime'"
    ...
    untestedPowerShellVersionWarningMessage                           = '[AVVERTENZA] Pode {0} non è stato testato su PowerShell {1}, poiché non era disponibile quando Pode è stato rilasciato.'
    ...
    deprecatedTitleVersionDescriptionWarningMessage                   = "AVVERTENZA: Titolo, Versione e Descrizione su 'Enable-PodeOpenApi' sono deprecati. Si prega di utilizzare 'Add-PodeOAInfo' invece."
