@{
    ...
    chainCertificateNotSupportedByPwshVersionExceptionMessage         = 'Le catene di certificati non sono supportate in PowerShell {0}. Usa PowerShell 7.5 o successivo.'
}