@{
    ...
    fileWatcherAlreadyDefinedExceptionMessage                         = "Een Bestandsbewaker genaamd '{0}' is al gedefinieerd."
    noServiceHandlersDefinedExceptionMessage                          = 'Er zijn geen Service-handlers gedefinieerd.'
    secretRequiredForCustomSessionStorageExceptionMessage             = 'Een Geheim is vereist bij het gebruik van aangepaste sessieopslag.'
    secretManagementModuleNotInstalledExceptionMessage                = 'Microsoft.PowerShell.SecretManagement-module is niet geïnstalleerd.'
    ...
    oauth2InnerSchemeInvalidExceptionMessage                          = 'OAuth2 InnerScheme kan alleen een van Basis- of Formulierauthenticatie zijn, maar kreeg: {0}'
    noRoutePathSuppliedForPageExceptionMessage                        = 'Geen routepad opgegeven voor {0} pagina.'
    cacheStorageNotFoundForExistsExceptionMessage                     = "Cache-opslag met naam '{0}' niet gevonden bij poging om te controleren of het gecachte item '{1}' bestaat."
    ...
    sessionsRequiredForSessionPersistentAuthExceptionMessage          = 'Sessie-persistentie-authenticatie vereist sessies.'
    invalidPathWildcardOrDirectoryExceptionMessage                    = 'Het opgegeven Pad kan geen wildcard of directory zijn: {0}'
    ...
    durationMustBeZeroOrGreaterExceptionMessage                       = 'Duur moet 0 of meer zijn, maar kreeg: {0}s'
    viewsPathDoesNotExistExceptionMessage                             = 'Het pad van de weergaven bestaat niet: {0}'
    discriminatorIncompatibleWithAllOfExceptionMessage                = "De parameter 'Discriminator' is onverenigbaar met 'allOf'."
    noNameForWebSocketSendMessageExceptionMessage                     = 'Geen Naam opgegeven voor een WebSocket om een bericht naar te verzenden.'
    hashtableMiddlewareNoLogicExceptionMessage                        = 'Een verstrekte Hashtable Middleware heeft geen Logica gedefinieerd.'
    openApiInfoMessage                                                = 'OpenAPI-informatie:'
    invalidSchemeForAuthValidatorExceptionMessage                     = "Het opgegeven '{0}' Schema voor de '{1}' authenticatievalidator vereist een geldig ScriptBlock."
    sseFailedToBroadcastExceptionMessage                              = 'SSE-uitzending mislukt vanwege gedefinieerd SSE-uitzendniveau voor {0}: {1}'
    adModuleWindowsOnlyExceptionMessage                               = 'Active Directory-module alleen beschikbaar op Windows OS.'
    requestLoggingAlreadyEnabledExceptionMessage                      = 'Verzoekregistratie is al ingeschakeld.'
