@{
    ...
    chainCertificateNotSupportedByPwshVersionExceptionMessage         = 'Les chaînes de certificats ne sont pas prises en charge dans PowerShell {0}. Veuillez utiliser PowerShell 7.5 ou une version ultérieure.'
}
