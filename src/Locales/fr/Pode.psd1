@{
    ...
    renamePodeOADefinitionTagNameExceptionMessage                     = "Rename-PodeOADefinitionTagName ne peut pas être utilisé à l'intérieur d'un 'ScriptBlock' de Select-PodeOADefinition."
}
