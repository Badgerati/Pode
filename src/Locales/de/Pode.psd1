@{
    ...
    chainCertificateNotSupportedByPwshVersionExceptionMessage         = 'Zertifikatketten werden in PowerShell {0} nicht unterstützt. Bitte verwenden Sie PowerShell 7.5 oder neuer.'
}