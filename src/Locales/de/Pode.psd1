...
outputMethodRequiresValidScriptBlockForRequestLoggingExceptionMessage = Die angegebene Ausgabemethode für die Anforderungsprotokollierung erfordert einen gültigen ScriptBlock.
...
sseConnectionNameRequiredExceptionMessage = Ein SSE-Verbindungsname ist erforderlich, entweder von -Name oder $WebEvent.Sse.Name
...
cannotLockValueTypeExceptionMessage = Kann [ValueTypes] nicht sperren.
...
cannotUnlockValueTypeExceptionMessage = Kann [ValueTypes] nicht entsperren.
