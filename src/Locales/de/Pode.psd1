@{
    ...
    renamePodeOADefinitionTagNameExceptionMessage                     = "Rename-PodeOADefinitionTagName kann nicht innerhalb eines 'ScriptBlock' von Select-PodeOADefinition verwendet werden."
}