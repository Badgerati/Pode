...
invalidContentTypeForSchemaExceptionMessage = 스키마에 대해 잘못된 콘텐츠 유형이 발견되었습니다: {0}
...
paramsNoAdditionalPropertiesExclusiveExceptionMessage = Params -NoAdditionalProperties와 -AdditionalProperties는 서로 배타적입니다.
