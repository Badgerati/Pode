...
<#
.SYNOPSIS
Adds a custom body parser.

.DESCRIPTION
Adds a custom body parser script for a content-type, which will be used if a payload is sent with a Request.
...
.DESCRIPTION
Removes a custom body parser script for a content-type.
