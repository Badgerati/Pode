...
Describe 'ConvertFrom-PodeCustomDictionaryJson' {
    It 'Should correctly deserialize a Hashtable' {
        $json = '{"Type":"Hashtable","Items":[{"Key":"Foo","Value":"Bar"},{"Key":"Baz","Value":42}]}'
    ...
    It 'Should correctly deserialize a ConcurrentDictionary' {
        $json = '{"Type":"ConcurrentDictionary","Items":[{"Key":"Key1","Value":123},{"Key":"Key2","Value":"Test"}]}'
        $result = ConvertFrom-PodeCustomDictionaryJson -Json $json
    ...
    It 'Should correctly deserialize an OrderedDictionary' {
        $json = '{"Type":"OrderedDictionary","Items":[{"Key":"First","Value":1},{"Key":"Second","Value":2}]}'
        $result = ConvertFrom-PodeCustomDictionaryJson -Json $json
    ...
    It 'Should correctly deserialize a ConcurrentBag' {
        $json = '{"Type":"ConcurrentBag","Items":["Item1","Item2","Item3"]}'
        $result = ConvertFrom-PodeCustomDictionaryJson -Json $json
    ...
    It 'Should correctly deserialize a PSCustomObject' {
        $json = '{"Name":"John","Age":30,"__PsTypeName__":"CustomType"}'
        $result = ConvertFrom-PodeCustomDictionaryJson -Json $json
    ...
    It 'Should correctly deserialize a recursively nested dictionary' {
        $json = '{"Type":"Hashtable","Items":[{"Key":"Level1","Value":{"Type":"OrderedDictionary","Items":[{"Key":"Level2","Value":{"Type":"Hashtable","Items":[{"Key":"Final","Value":"Reached"}]}}]}}]}'
        $result = ConvertFrom-PodeCustomDictionaryJson -Json $json
...
Describe 'ConvertTo-PodeCustomDictionaryJson' {
    It 'Should correctly serialize a recursively nested dictionary' {
        ...
        $expected = '{"Type":"Hashtable","Items":[{"Key":"Level1","Value":{"Type":"Hashtable","Items":[{"Key":"Level2","Value":{"Type":"Hashtable","Items":[{"Key":"Final","Value":"Reached"}]}}]}}]}' |
    ...
    It 'Should correctly serialize a dictionary with multiple types' {
        ...
        $json = ConvertTo-PodeCustomDictionaryJson -Dictionary $dictionary | ConvertFrom-Json | Convert-PsCustomObjectToOrderedHashtable
        $expected = '{"Type":"Hashtable","Items":[{"Key":"Array","Value":[1,2,3]},{"Key":"Number","Value":123},{"Key":"String","Value":"Test"},{"Key":"Boolean","Value":true}]}' |
            ConvertFrom-Json | Convert-PsCustomObjectToOrderedHashtable

        $json.Type | Should -Be 'Hashtable'
        Compare-Hashtable $json $expected | Should -BeTrue
    }
    ...
    It 'Should correctly serialize nested dictionaries and collections' {
        ...
        $json = ConvertTo-PodeCustomDictionaryJson -Dictionary $dictionary | ConvertFrom-Json | Convert-PsCustomObjectToOrderedHashtable
        $expected = '{"Type":"Hashtable","Items":[{"Key":"Dict","Value":{"Type":"Hashtable","Items":[{"Key":"SubDict","Value":{"Type":"Hashtable","Items":[{"Key":"Key","Value":"Value"}]}}]}},{"Key":"List","Value":[1,2,{"Type":"Hashtable","Items":[{"Key":"Nested","Value":"Yes"}]}]}]}' |
            ConvertFrom-Json | Convert-PsCustomObjectToOrderedHashtable
    ...
    It 'Should correctly serialize thread-safe collections' {
        ...
        $json = ConvertTo-PodeCustomDictionaryJson -Dictionary $dictionary | ConvertFrom-Json  | Convert-PsCustomObjectToOrderedHashtable
        $expected = '{"Type":"Hashtable","Items":[{"Key":"ConcurrentDict","Value":{"Type":"ConcurrentDictionary","Items":[{"Key":"Key1","Value":"Value1"},{"Key":"Key2","Value":42}]}},{"Key":"ConcurrentBag","Value":{"Type":"ConcurrentBag","Items":["Item2","Item1"]}}]}' |
            ConvertFrom-Json | Convert-PsCustomObjectToOrderedHashtable
