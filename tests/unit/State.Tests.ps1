...
Describe 'Set-PodeState' {
    It 'Throws error when not initialised' {
        ...
        { Set-PodeState -Name 'test' } | Should -Throw -ExpectedMessage $msgTable.podeNotInitializedExceptionMessage # Pode has not been initialized.
    }
...
Describe 'Get-PodeState' {
    It 'Throws error when not initialised' {
        $PodeContext.Server = @{ 'State' = $null }
        { Get-PodeState -Name 'test' } | Should -Throw -ExpectedMessage $msgTable.podeNotInitializedExceptionMessage # Pode has not been initialized.
    }
...
Describe 'Remove-PodeState' {
    It 'Throws error when not initialised' {
        $PodeContext.Server = @{ 'State' = $null }
        { Remove-PodeState -Name 'test' } | Should -Throw -ExpectedMessage $msgTable.podeNotInitializedExceptionMessage # Pode has not been initialized.
    }
...
Describe 'Save-PodeState' {
    It 'Throws error when not initialised' {
        $PodeContext.Server = @{ 'State' = $null }
        { Save-PodeState -Path 'some/path' } | Should -Throw -ExpectedMessage $msgTable.podeNotInitializedExceptionMessage # Pode has not been initialized.
    }
...
Describe 'Restore-PodeState' {
    It 'Throws error when not initialised' {
        $PodeContext.Server = @{ 'State' = $null }
        { Restore-PodeState -Path 'some/path' } | Should -Throw -ExpectedMessage $msgTable.podeNotInitializedExceptionMessage # Pode has not been initialized.
    }
...
Describe 'Test-PodeState' {
    It 'Throws error when not initialised' {
        $PodeContext.Server = @{ 'State' = $null }
        { Test-PodeState -Name 'test' } | Should -Throw -ExpectedMessage $msgTable.podeNotInitializedExceptionMessage # Pode has not been initialized.
    }
