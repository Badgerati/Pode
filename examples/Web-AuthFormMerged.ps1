...
Start-PodeServer -Threads 2 {
    ...
    New-PodeAuthFormScheme | Add-PodeAuth -Name 'Login1' -FailureUrl '/login' -SuccessUrl '/' -ScriptBlock {
    ...
    New-PodeAuthFormScheme | Add-PodeAuth -Name 'Login2' -FailureUrl '/login' -SuccessUrl '/' -ScriptBlock {
        param($username, $password)
