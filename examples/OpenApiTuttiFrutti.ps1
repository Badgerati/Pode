...
(New-PodeOAIntProperty -Name 'packSize'  -Description 'the size of the pack the dog is from' -Default 0 -Minimum 0 -Format Int32 -Required -Object ) |
    ...
    Add-PodeRouteGroup -Path '/api/v3'   -Routes {
        ...
        Add-PodeRoute -PassThru -Method get -Path '/pet/findByTag' -Authentication 'test' -Scope 'read' -ScriptBlock {
            ...
            Add-PodeOAResponse -StatusCode 200 -Description 'Successful operation' -Content (New-PodeOAContentMediaType -ContentMediaType 'application/json', 'application/xml' -Content 'Pet' ) -PassThru | #missing array   application/json:
            # schema:
            #  type: array
            #  items:
            #     $ref: '#/components/schemas/Pet'
            Add-PodeOAResponse -StatusCode 400 -Description 'Invalid status value' -PassThru |
            Add-PodeOAResponse -Default  -Description 'Unexpected error' -Content  (New-PodeOAContentMediaType -ContentMediaType 'application/json'  -Content 'ErrorModel' )
        ...
        Add-PodeRoute -PassThru -Method post -Path '/pet4/:petId' -Authentication 'Login-OAuth2' -Scope 'write' -ScriptBlock {
            ...
            Set-PodeOARequest -PassThru -Parameters @(( ConvertTo-PodeOAParameter -Reference 'PetIdParam'  ),
                    ...
                    New-PodeOAStringProperty -name 'id' -format 'uuid' |
                        ...
                        ) | Add-PodeOAResponse -StatusCode 200 -PassThru  -Description 'A simple string response'   -Content (  New-PodeOAContentMediaType -ContentMediaType 'text/plain' -Content ( New-PodeOAStringProperty) ) |
                        Add-PodeOAResponse -StatusCode 400 -Description 'Invalid ID supplied' -PassThru |
                        Add-PodeOAResponse -StatusCode 405 -Description 'Invalid Input'
        ...
        Add-PodeRoute -PassThru -Method post -Path '/pet/:petId/uploadImage2' -ScriptBlock {
            ...
            Add-PodeOAResponse -StatusCode 200 -Description 'A simple string response' -Content  (
                New-PodeOAContentMediaType  -ContentMediaType 'text/plain' -Content ( New-PodeOAStringProperty -Example 'whoa!') )  -Headers (
        ...
        Add-PodeRoute -PassThru -Method post -Path '/pet/:petId/uploadmultiImage' -ScriptBlock {
            ...
            Set-PodeOARequest -Parameters @(
                ...
                New-PodeOARequestBody -Required -Content  ( New-PodeOAContentMediaType -ContentMediaType 'multipart/form-data' -Upload -PartContentMediaType 'application/octect-stream' -Content (
        ...
        Add-PodeRoute -PassThru -Method post -Path '/pet/:petId/uploadImageOctet' -ScriptBlock {
            ...
            Set-PodeOARequest -Parameters @(
                ...
                New-PodeOARequestBody -Required -Content  ( New-PodeOAContentMediaType -ContentMediaType 'application/octet-stream' -Upload )
            ) -PassThru |
            Add-PodeOAResponse -StatusCode 200 -Description 'Successful operation' -Content @{'application/json' = 'ApiResponse' } -PassThru |
            Add-PodeOAResponse -StatusCode 400 -Description 'Invalid ID supplied' -PassThru |
            Add-PodeOAResponse -StatusCode 405 -Description 'Invalid Input'
        ...
        Add-PodeRoute -PassThru -Method post -Path '/store/order' -ScriptBlock {
            ...
            Set-PodeOARequest -RequestBody (New-PodeOARequestBody -Required -Content (New-PodeOAContentMediaType -ContentMediaType 'application/json', 'application/xml', 'application/x-www-form-urlencoded' -Content 'Order'  )) -PassThru |
        ...
        Add-PodeRoute -PassThru -Method post -Path '/user' -ScriptBlock {
            ...
            Set-PodeOARequest -RequestBody (New-PodeOARequestBody -Required -Content (New-PodeOAContentMediaType -ContentMediaType 'application/json', 'application/xml', 'application/x-www-form-urlencoded' -Content 'User' )) -PassThru |
        ...
        Add-PodeRoute -PassThru -Method Put -Path '/user_1/:username' -OAResponses $Responses -ScriptBlock {
            ...
            ) -RequestBody (New-PodeOARequestBody -Required -Content (New-PodeOAContentMediaType -ContentMediaType 'application/json', 'application/xml', 'application/x-www-form-urlencoded' -Content 'User' ))
        ...
        Add-PodeRoute -PassThru -Method Put -Path '/user/:username' -ScriptBlock {
            ...
            Set-PodeOARequest -Parameters @(
            (  New-PodeOAStringProperty -Name 'username' -Description ' name that need to be updated.' -Required | ConvertTo-PodeOAParameter -In Path )
            ) -RequestBody (New-PodeOARequestBody -Required -Content (New-PodeOAContentMediaType -ContentMediaType 'application/json', 'application/xml', 'application/x-www-form-urlencoded' -Content 'User' )) -PassThru |
            Add-PodeOAResponse -StatusCode 200 -Reference 'UserOpSuccess' -PassThru |
            Add-PodeOAResponse -StatusCode 400 -Description 'Invalid username supplied' -PassThru |
