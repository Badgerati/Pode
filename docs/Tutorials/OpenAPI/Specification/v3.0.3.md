...
| <a name="oasInfo"></a>info                 |                  [Info Object](#infoObject)                   | [`Add-PodeOAInfo`](../../../../Functions/OpenApi/Add-PodeOAInfo)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | **REQUIRED**. Provides metadata about the API. The metadata MAY be used by tooling as required.                                                                                                                                                                                                                                                                                                           |
...
| <a name="oasSecurity"></a>security         |  [[Security Requirement Object](#securityRequirementObject)]  | [`New-PodeAuthBasicScheme`](../../../../Functions/Authentication/New-PodeAuthBasicScheme)<br> [`New-PodeAuthFormScheme`](../../../../Functions/Authentication/New-PodeAuthFormScheme)<br> [`New-PodeAuthDigestScheme`](../../../../Functions/Authentication/New-PodeAuthDigestScheme)<br> [`New-PodeAuthBearerScheme`](../../../../Functions/Authentication/New-PodeAuthBearerScheme)<br> [`New-PodeAuthClientCertificateScheme`](../../../../Functions/Authentication/New-PodeAuthClientCertificateScheme)<br> [`New-PodeAuthOAuth2Scheme`](../../../../Functions/Authentication/New-PodeAuthOAuth2Scheme)<br> [`New-PodeAuthApiKeyScheme`](../../../../Functions/Authentication/New-PodeAuthApiKeyScheme)<br> [`New-PodeAuthNegotiateScheme`](../../../../Functions/Authentication/New-PodeAuthNegotiateScheme)<br> [`New-PodeAuthCustomScheme`](../../../../Functions/Authentication/New-PodeAuthCustomScheme)<br>             [`Merge-PodeAuthScheme`](../../../../Functions//Merge-PodeAuthScheme) <br>                                               [`Add-PodeRoute`](../../../../Functions/Routes/Add-PodeRoute)<br>                                                                                                                                                                                                                          | A declaration of which security mechanisms can be used across the API. The list of values includes alternative security requirement objects that can be used. Only one of the security requirement objects need to be satisfied to authorize a request. Individual operations can override this definition. To make security optional, an empty security requirement (`{}`) can be included in the array. |
...
| <a name="componentsSecuritySchemes"></a> securitySchemes | Map[`string`, [Security Scheme Object](#securitySchemeObject) \| [Reference Object](#referenceObject)] | [`New-PodeAuthBasicScheme`](../../../../Functions/Authentication/New-PodeAuthBasicScheme)<br> [`New-PodeAuthFormScheme`](../../../../Functions/Authentication/New-PodeAuthFormScheme)<br> [`New-PodeAuthDigestScheme`](../../../../Functions/Authentication/New-PodeAuthDigestScheme)<br> [`New-PodeAuthBearerScheme`](../../../../Functions/Authentication/New-PodeAuthBearerScheme)<br> [`New-PodeAuthClientCertificateScheme`](../../../../Functions/Authentication/New-PodeAuthClientCertificateScheme)<br> [`New-PodeAuthOAuth2Scheme`](../../../../Functions/Authentication/New-PodeAuthOAuth2Scheme)<br> [`New-PodeAuthApiKeyScheme`](../../../../Functions/Authentication/New-PodeAuthApiKeyScheme)<br> [`New-PodeAuthNegotiateScheme`](../../../../Functions/Authentication/New-PodeAuthNegotiateScheme)<br> [`New-PodeAuthCustomScheme`](../../../../Functions/Authentication/New-PodeAuthCustomScheme) | An object to hold reusable [Security Scheme Objects](#securitySchemeObject). |
...
New-PodeAuthApiKeyScheme -Location Header | Add-PodeAuth -Name 'api_key' -Sessionless -ScriptBlock {
        param($key)
            #logic goes here
}
...
New-PodeAuthOAuth2Scheme -ClientId $ClientId -ClientSecret $ClientSecret -AuthoriseUrl "http://example.org/api/oauth/dialog" `
...
```powershell
New-PodeAuthBasicScheme | Add-PodeAuth -Name 'basic' -ScriptBlock {
...
```powershell
 New-PodeAuthApiKeyScheme -Location 'Header' | Add-PodeAuth -Name 'ApiKey' -ScriptBlock {
        param($key)
...
```powershell
New-PodeAuthApiKeyScheme | Add-PodeAuth -Name 'api_key' -Sessionless -ScriptBlock {
  param($username, $password)
  # check if the user is valid
  return @{ User = $user }
}
