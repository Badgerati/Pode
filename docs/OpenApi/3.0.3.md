...
| Field Name                                       |                                           Type                                            | Pode example (`$Route = Add-PodeRoute -PassThru -Method Get -Path '/pet/:petId' -ScriptBlock { Write-PodeJsonResponse -Value 'done' -StatusCode 200 }` )                                             | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| ------------------------------------------------ | :---------------------------------------------------------------------------------------: | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
```powershell
New-PodeOARequestBody -Description 'user to add to the system' -ContentSchemas @{ 'application/json' = 'User'; 'application/xml' = 'User'}  `
  -ContentSchemasExamples @{ 'application/json' =  New-PodeOAExample -Name 'user' -Example @{ "summary"= "User Example";"externalValue"= "http://foo.bar/examples/user-example.json"} ; 'application/xml' =  New-PodeOAExample -Name 'user' -Example @{ "summary"= "User Example in XML";"externalValue"= "http://foo.bar/examples/user-example.xml"};
  'text/plain' =  New-PodeOAExample -Name 'user' -Example @{ "summary"= "User Example in Plain text";"externalValue"= "http://foo.bar/examples/user-example.txt" } }
```
```json
{
