...
| maxLength                       | `-MaxLength`        |
| minLength                       | `-MinLength`        |
| pattern                         | `-Pattern`          | (This string SHOULD be a valid regular expression, according to the [Ecma-262 Edition 5.1 regular expression](https://www.ecma-international.org/ecma-262/5.1/#sec-15.10.1) dialect) |
| maxItems                        | `-MaxItems`         |
| minItems                        | `-MinItems`         |
