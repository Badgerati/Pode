...
```
```Powershell
Enable-PodeOpenApi -Path '/docs/openapi' -Title 'Sample Pet Store App' -Version 1.0.1 `
  -Description 'This is a sample server for a pet store.'  -OpenApiVersion '3.0.3'

Add-PodeOAInfo -TermsOfService 'http://example.com/terms/' -License 'Apache 2.0' `
