...
| required         | `-Required`                                                                                                                                   | `New-PodeOAIntProperty` \| `New-PodeOAStringProperty`  \| `New-PodeOABoolProperty` \| `New-PodeOANumberProperty` \| `New-PodeOObjectProperty`                                                                                                                                                                                           |
| enum             | `-Enum`                                                                                                                                       | `New-PodeOAIntProperty` \| `New-PodeOAStringProperty`  \| `New-PodeOABoolProperty` \| `New-PodeOANumberProperty` \| `New-PodeOObjectProperty`                                                                                                                                                                                           |
| items            | `-Array`                                                                                                                                      | `New-PodeOAIntProperty` \| `New-PodeOAStringProperty`  \| `New-PodeOABoolProperty` \| `New-PodeOANumberProperty` \| `New-PodeOObjectProperty`                                                                                                                                                                                           |
...
```powershell
New-PodeOAIntProperty  -Name 'id' -Format Int32 -Xml @{'attribute'=$true} |
  New-PodeOAStringProperty  -Name 'name' -Format Int32 -Xml @{'namespace'='http://example.com/schema/sample'; 'prefix'='sample'} |
  New-PodeOAObjectProperty -Name 'Person'
```
```json
{
  "Person": {
