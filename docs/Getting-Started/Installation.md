...
docker pull badgerati/pode:2.13.3
```
...
# or the following for a specific version:
docker pull badgerati/pode:2.13.3-alpine
```
...
# or the following for a specific version:
docker pull badgerati/pode:2.13.3-arm32
```
...
# or the following for a specific version:
docker pull docker.pkg.github.com/badgerati/pode/pode:2.13.3
```
...
# or the following for a specific version:
docker pull docker.pkg.github.com/badgerati/pode/pode:2.13.3-alpine
```
...
# or the following for a specific version:
docker pull docker.pkg.github.com/badgerati/pode/pode:2.13.3-arm32
```
